const { msgError } = require('./util.js');
const { Loader } = require('./loader.js');

class Form {
    constructor(form, formCompletedCallback, tabChangeCallback) {
        this.form = form;
    ...
    validateData() {
        let fieldList = this.tabList[this.currentTab].tab.querySelectorAll('.form-input, .form-control, .form-select, .checkbox__input');
        ...
        fieldList.forEach(field => {
            this.values[field.name] = (field.type === 'checkbox') ? field.checked : field.value;
